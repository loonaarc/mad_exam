...
private fun StatisticsContent(
    ...
    LoadingContent(
        ...
        Column(
            ...
            if (!loading) {
                StatisticsCard(
                    label = R.string.statistics_active_tasks_label,
                    percent = activeTasksPercent,
                    color = ActiveTasksColor
                )
                StatisticsCard(
                    label = R.string.statistics_completed_tasks_label,
...
private val ActiveTasksColor = Color(0xFFFF9800)
